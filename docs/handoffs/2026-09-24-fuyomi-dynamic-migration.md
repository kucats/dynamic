...
- Concurrent PR update integrated without force-push: `509007f` (additional Nabucco and Horn II drafts)
- Fuyomi port commit: `0f67f88`
- First integration commit: `fc9d001fbb178449f57a5bcfb1708bb0eb6bcb95`
- Latest integration snapshot: `77f92f145eae7d08834656e31e5b8d00db248180`
...
- Integrated the concurrent Nabucco prior/overview/Fuyomi drafts and Horn II Movement I/III draft excerpts. Their limits and unresolved audits remain visible in the catalog; the score-reading compatibility entry point now calls the local engine rather than vEdit.
...
- `python3 tools/validate_catalog.py` — pass; 6 Fuyomi items and 9 artifacts verified, 8 composer-catalog items/paths/links/hashes valid, Horn II playback fail-closed.
...
The inherited PDF review checked representative pages for the large-label Trombone II guide, four-page same-pages excerpt, Trombone III trial PDF, and provisional Nabucco PDF. The eight composer-catalog PDFs were page-count checked; the new Horn II Movement I excerpt's first page was also rendered and visually inspected. Poppler fontconfig errors prevented completing a visual pass over the other concurrent PDFs. No original score PDF was copied into the repository.

## Unresolved score work and stop boundary

- Dvořák Horn II has independent source audits for all four movements, but complete note/rhythm transcriptions remain unfinished. Continuous playback is disabled. First-generation Movement I/III exports are archived as superseded; newer public excerpts are drafts with unresolved pitches, cues, and durations and are not approved for practice.
- Nabucco Trombone II pages 2–4 have several draft versions (including a 401-label/729-event prior reading and 455 Fuyomi candidates); B-natural/sharp review, source-context, and rhythm validation are incomplete. Playback is disabled.
