...
- `public/reader/` — 譜読みアプリ本体。ホルンの記譜ドレミ・F管読み・実音・運指の目安（親指レバーは4、オン／オフ、[docs/horn-fingering.md](docs/horn-fingering.md)）、トロンボーンの音名・基本ポジション、タップ試聴・通し再生・ロングトーン練習・小節番号の位置切り替え・小節ジャンプ・拡大・印刷に対応。データは `public/reader/data/<id>.json`
