...
def render(data,images,out,font_regular,font_bold):
    ...
    pdf=canvas.Canvas(str(out/'dvorak8-trombone1-movement4-pitch-reading.pdf'))
    pdf.setTitle('Dvorak 8 - Trombone I, fourth movement - concert pitch reading')
    ...
    for page in doc['pages']:
        ...
        for start in range(0,len(strips),3):
            ...
            pdf.setPageSize((pw,ph));pdf.setFont('Helvetica-Bold',18);pdf.drawString(30,ph-27,'Dvorak Symphony No. 8 | Trombone I | Movement IV')
            ...
            pdf.setFont('Helvetica',9);pdf.drawString(30,ph-58,'Large pitch and primary slide position beneath each TB1 note. Tiny pale digit = octave.')
            pdf.drawString(30,ph-71,'Printed orchestral cues are unlabelled. Amber = check the score before playing.')
