...
```sh
python3 project/dvorak/symphony-no-8/trombone-i/publication-source/movement-iv/transcribe.py \
...
```sh
python3 project/dvorak/symphony-no-8/trombone-i/publication-source/movement-iv/render.py \
